...
" GoTo Eat Ishikawa
command! -nargs=1 -complete=customlist,tanikawa#goto_eat_ishikawa#ComplIshikawaCategory GTEGetShopList call tanikawa#goto_eat_ishikawa#GetGotoEatShopList(<q-args>)
...
" DebugCommand
command! GTEZZZDebug call <SID>GTEDebugCmd()
func! s:GTEDebugCmd() abort
